...
- (void)print
{
    NSLog(@"LFXSuperResult = %@ \n"
          ...
          self.shortValue, self.unsignedShortValue,
          self.intValue, self.unsignedIntValue,
          self.longValue, self.unsignedLongValue,
          self.longLongValue, self.unsignedLongLongValue,
